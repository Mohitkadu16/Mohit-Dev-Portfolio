  ...
  return (
    <section className="hero" id="hero">
      <div className="hero-content">
        <img src="/public/hero img.png" alt="Hero" className="hero-img" style={{width: '160px', height: '160px', borderRadius: '50%', marginBottom: '1.5rem', border: '5px solid #2196f3', background: '#181818'}} />
